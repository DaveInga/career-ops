...
The template below is the English scaffold. **Translate it to the resolved
output language** before presenting; do not emit English when the user is
...
Customize each section with the specific context of the evaluated offer, in
the language resolved in the **Language** section above (NOT always English).
